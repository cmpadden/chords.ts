...
describe("identify", () => {
  const combinations = [
    ...
    { notes: [0, 1], name: "C# / Db No 3 Major 7" },
    { notes: [0, 2], name: "D No 3 7" },
    { notes: [0, 3], name: "C Minor" },
    { notes: [0, 4], name: "C" },
    { notes: [0, 5], name: "F 5" },
    { notes: [0, 6], name: "D 7" },
    { notes: [0, 7], name: "C 5" },
    ...
    { notes: [1, 4], name: "C# / Db Minor" },
    { notes: [1, 5], name: "C# / Db" },
    { notes: [1, 6], name: "F# / Gb 5" },
    { notes: [1, 7], name: "D# / Eb 7" },
    { notes: [1, 8], name: "C# / Db 5" },
    { notes: [1, 9], name: "A" },
    { notes: [1, 10], name: "A# / Bb Minor" },
    { notes: [1, 11], name: "C# / Db No 3 7" },

    { notes: [2, 3], name: "D# / Eb No 3 Major 7" },
    { notes: [2, 4], name: "E No 3 7" },
    { notes: [2, 5], name: "D Minor" },
    { notes: [2, 6], name: "D" },
    { notes: [2, 7], name: "G 5" },
    { notes: [2, 8], name: "E 7" },
    { notes: [2, 9], name: "D 5" },
    { notes: [2, 10], name: "A# / Bb" },
    { notes: [2, 11], name: "B Minor" },

    { notes: [3, 4], name: "E No 3 Major 7" },
    { notes: [3, 5], name: "F No 3 7" },
    { notes: [3, 6], name: "D# / Eb Minor" },
    { notes: [3, 7], name: "D# / Eb" },
    { notes: [3, 8], name: "G# / Ab 5" },
    { notes: [3, 9], name: "F 7" },
    { notes: [3, 10], name: "D# / Eb 5" },
    { notes: [3, 11], name: "B" },

    { notes: [4, 5], name: "F No 3 Major 7" },
    { notes: [4, 6], name: "F# / Gb No 3 7" },
    { notes: [4, 7], name: "E Minor" },
    { notes: [4, 8], name: "E" },
    { notes: [4, 9], name: "A 5" },
    { notes: [4, 10], name: "F# / Gb 7" },
    { notes: [4, 11], name: "E 5" },

    { notes: [5, 6], name: "F# / Gb No 3 Major 7" },
    { notes: [5, 7], name: "G No 3 7" },
    { notes: [5, 8], name: "F Minor" },
    { notes: [5, 9], name: "F" },
    { notes: [5, 10], name: "A# / Bb 5" },
    { notes: [5, 11], name: "G 7" },

    { notes: [6, 7], name: "G No 3 Major 7" },
    { notes: [6, 8], name: "G# / Ab No 3 7" },
    { notes: [6, 9], name: "F# / Gb Minor" },
    { notes: [6, 10], name: "F# / Gb" },
    { notes: [6, 11], name: "B 5" },

    { notes: [7, 8], name: "G# / Ab No 3 Major 7" },
    { notes: [7, 9], name: "A No 3 7" },
    { notes: [7, 10], name: "G Minor" },
    { notes: [7, 11], name: "G" },

    { notes: [8, 9], name: "A No 3 Major 7" },
    { notes: [8, 10], name: "A# / Bb No 3 7" },
    { notes: [8, 11], name: "G# / Ab Minor" },

    { notes: [9, 10], name: "A# / Bb No 3 Major 7" },
    ...
    { notes: [0, 1, 6], name: "F# / Gb 5 Sharp 11" },
    ...
    { notes: [1, 9, 10], name: "F# / Gb Sharp 9" },
    ...
    { notes: [4, 5, 6], name: "F# / Gb No 3 7 Major 7" },
    ...
    { notes: [4, 6, 9], name: "F# / Gb Minor 7" },
    { notes: [4, 6, 10], name: "F# / Gb Major 7" },
    ...
    { notes: [5, 6, 10], name: "F# / Gb Major 7" },
    ...
    { notes: [6, 7, 9], name: "F# / Gb Minor Add Flat 9" },
    { notes: [6, 7, 10], name: "D# / Eb Sharp 9" },
    { notes: [6, 7, 11], name: "G Major 7" },

    { notes: [6, 8, 9], name: "F# / Gb Minor Add 9" },
    { notes: [6, 8, 10], name: "F# / Gb Add 9" },
    { notes: [6, 8, 11], name: "G# / Ab Minor 7" },

    { notes: [6, 9, 10], name: "F# / Gb Sharp 9" },
    ...
    // C inversions
    { notes: [52, 55, 60], name: "C" },
    { notes: [55, 60, 64], name: "C" },

    // D inversions
    { notes: [54, 57, 62], name: "D" },
    { notes: [57, 62, 66], name: "D" },

    // A inversions
    { notes: [49, 52, 57], name: "A" }, // 1st inversion major
    { notes: [48, 52, 57], name: "A Minor" }, // 1st inversion minor

    // F inversions
    { notes: [48, 53, 57], name: "F" }, // 2nd inversion major
  ...
  it("should identify a basic C-major chord with high C", () => {
    expect(identify([48, 52, 55, 60]).name).toEqual("C");
  });
